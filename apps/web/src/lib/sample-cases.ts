...
export const SAMPLE_CASES: SampleCase[] = [
  ...
  // Case 10: Pediatric GBM - Brain MRI (High-Grade Glioma)
  {
    id: "pediatric-gbm-brain",
    caseNumber: 10,
    patient: {
      name: "Arjun Malhotra",
      age: 12,
      gender: "Male",
      ecog: 1,
      comorbidities: "None (previously healthy child)",
      insurance: "Private (ICICI Lombard)",
      location: "DL",
    },
    cancer: {
      type: "BRAIN",
      subtype: "Glioblastoma (Pediatric-type)",
      histology: "High-grade glioma, WHO Grade 4, H3 G34-mutant",
      primarySite: "Left frontoparietal lobe",
      stage: "Localized (CNS only)",
      tnm: { t: "T3", n: "N0", m: "M0" },
      stagingSystem: "WHO CNS5",
    },
    biomarkers: [
      { name: "H3 G34R/V", value: "Positive (G34R)", actionable: true },
      { name: "IDH1/2", value: "Wild-type", actionable: true },
      { name: "MGMT Promoter", value: "Unmethylated", actionable: true },
      { name: "ATRX", value: "Loss", actionable: false },
      { name: "TP53", value: "Mutated", actionable: false },
    ],
    genomics: {
      mutations: [
        { gene: "H3F3A", variant: "G34R", actionable: true },
        { gene: "TP53", variant: "R273H", actionable: false },
        { gene: "ATRX", variant: "Truncating", actionable: false },
        { gene: "PDGFRA", variant: "Amplification", actionable: true },
      ],
      tmb: 4,
      msi: "MSS",
    },
    clinicalQuestion: "12-year-old boy with newly diagnosed left frontoparietal high-grade glioma (H3 G34-mutant, IDH-wildtype). MRI shows 5.2cm enhancing mass with central necrosis, surrounding edema, 8mm midline shift. Presenting with 3 weeks of headaches, right-sided weakness, and personality changes. What is the optimal surgical approach - maximal safe resection vs biopsy? Role of awake craniotomy in pediatric patient? Standard Stupp protocol appropriate? Consideration for clinical trials (ONC201, targeted therapy)? Psychosocial support for family?",
    keyConsiderations: ["Maximal safe resection planning", "H3 G34-mutant specific biology", "Pediatric chemoradiation dosing", "Neurocognitive preservation", "ONC201 and targeted therapy trials", "Family counseling and school accommodations"],
    expectedModalities: ["Surgery (craniotomy)", "Radiation therapy (reduced dose for pediatric)", "Temozolomide", "Possible ONC201 trial", "Rehabilitation"],
    incidenceContext: { usaRank: 15, indiaRank: 12, notes: "Most common malignant pediatric brain tumor, poor prognosis" },
  },
];
