...
// CDN Configuration
// Primary: Cloudflare R2 (fastest, global edge network)
// Fallback: GitHub Pages (reliable backup)
const R2_CDN_URL = 'https://pub-5a6a698537c843faba7912e64a54a70f.r2.dev';
