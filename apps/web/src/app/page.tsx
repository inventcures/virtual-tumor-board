...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      {/* Preprint Section */}
      <section className="py-8 sm:py-12 border-t border-slate-800/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-slate-900 border-2 border-indigo-500/40 shadow-lg shadow-indigo-500/10">
            {/* NEW Badge */}
            <div className="absolute -top-3 left-6 px-3 py-1 bg-gradient-to-r from-rose-500 to-orange-500 text-white text-xs font-bold rounded-full shadow-lg">
              NEW
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  <span className="px-2 py-1 bg-slate-800 text-slate-300 text-xs rounded-md">Multi-Agent AI</span>
                  <span className="px-2 py-1 bg-slate-800 text-slate-300 text-xs rounded-md">Clinical Guidelines RAG</span>
                  <span className="px-2 py-1 bg-slate-800 text-slate-300 text-xs rounded-md">Adversarial Deliberation</span>
