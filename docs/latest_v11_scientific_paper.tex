...
Email: \texttt{ashish.makani@ashoka.edu.in}

\vspace{0.5em}
\noindent\textbf{Author Contributions:}\\
A.M. conceived and designed the system architecture, implemented the multi-agent framework, and drafted the manuscript. A.A. provided clinical guidance, supervised the project, and critically revised the manuscript.

\vspace{0.5em}
\noindent\textbf{Conflict of Interest:} The authors declare no competing interests.

\vspace{0.5em}
\noindent\textbf{Funding:} This work was supported by the Koita Centre for Digital Health - Ashoka (KCDH-A).
